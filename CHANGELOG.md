...
- The following processes don't support `binary` any longer: `aggregate_temporal`, `resample_cube_temporal`. [#94](https://github.com/Open-EO/openeo-processes/issues/94)
